...
class ParameterArtifactProviderTest {
    ...
    void should_add_parameters_in_configuration() throws Exception {
        ...
        final ParameterArtifactProvider parameterProvider = new ParameterArtifactProvider(conf);
        ...
        when(configuration.getParameters())
                .thenReturn(new BasicEList<>(List.of(
                        parameter("host", "localhost", String.class.getName()),
