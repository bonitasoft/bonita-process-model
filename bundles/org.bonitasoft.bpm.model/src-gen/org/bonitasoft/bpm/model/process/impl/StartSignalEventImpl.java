 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getSignalCode <em>Signal Code</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getDynamicLabel <em>Dynamic Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getDynamicDescription <em>Dynamic Description</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getStepSummary <em>Step Summary</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.StartSignalEventImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
