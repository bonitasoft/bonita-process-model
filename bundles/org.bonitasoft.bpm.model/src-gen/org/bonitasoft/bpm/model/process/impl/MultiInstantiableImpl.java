 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getTestBefore <em>Test Before</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getLoopCondition <em>Loop Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getLoopMaximum <em>Loop Maximum</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#isUseCardinality <em>Use Cardinality</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getCardinalityExpression <em>Cardinality Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getCollectionDataToMultiInstantiate <em>Collection Data To Multi Instantiate</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getIteratorExpression <em>Iterator Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getOutputData <em>Output Data</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getListDataContainingOutputResults <em>List Data Containing Output Results</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#getCompletionCondition <em>Completion Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.MultiInstantiableImpl#isStoreOutput <em>Store Output</em>}</li>
 * </ul>
 *
 * @generated
 */
