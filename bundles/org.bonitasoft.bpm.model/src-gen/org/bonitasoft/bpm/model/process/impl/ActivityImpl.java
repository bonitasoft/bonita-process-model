 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getKpis <em>Kpis</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getTestBefore <em>Test Before</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getLoopCondition <em>Loop Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getLoopMaximum <em>Loop Maximum</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#isUseCardinality <em>Use Cardinality</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getCardinalityExpression <em>Cardinality Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getCollectionDataToMultiInstantiate <em>Collection Data To Multi Instantiate</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getIteratorExpression <em>Iterator Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getOutputData <em>Output Data</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getListDataContainingOutputResults <em>List Data Containing Output Results</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getCompletionCondition <em>Completion Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#isStoreOutput <em>Store Output</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.process.impl.ActivityImpl#getBoundaryIntermediateEvents <em>Boundary Intermediate Events</em>}</li>
 * </ul>
 *
 * @generated
 */
