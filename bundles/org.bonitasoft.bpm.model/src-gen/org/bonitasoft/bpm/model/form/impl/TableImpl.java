 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getValidators <em>Validators</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getUseDefaultValidator <em>Use Default Validator</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#isBelow <em>Below</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getExampleMessagePosition <em>Example Message Position</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getExampleMessage <em>Example Message</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getDefaultExpression <em>Default Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getDefaultExpressionAfterEvent <em>Default Expression After Event</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#isUsePagination <em>Use Pagination</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#isAllowSelection <em>Allow Selection</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#isSelectionModeIsMultiple <em>Selection Mode Is Multiple</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getMaxRowForPagination <em>Max Row For Pagination</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getColumnForInitialSelectionIndex <em>Column For Initial Selection Index</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.TableImpl#getSelectedValues <em>Selected Values</em>}</li>
 * </ul>
 *
 * @generated
 */
