...
import org.bonitasoft.bpm.model.form.Column;
import org.bonitasoft.bpm.model.form.Duplicable;
import org.bonitasoft.bpm.model.form.FormPackage;
import org.bonitasoft.bpm.model.form.Group;
import org.bonitasoft.bpm.model.form.GroupIterator;
import org.bonitasoft.bpm.model.form.LabelPosition;
import org.bonitasoft.bpm.model.form.Line;
import org.bonitasoft.bpm.model.form.Widget;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getHtmlAttributes <em>Html Attributes</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getWidgetLayoutInfo <em>Widget Layout Info</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getShowDisplayLabel <em>Show Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDependOn <em>Depend On</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display Dependent Widget Only On Event Triggered</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getParentOf <em>Parent Of</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isMandatory <em>Mandatory</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getLabelPosition <em>Label Position</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getRealHtmlAttributes <em>Real Html Attributes</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isInjectWidgetCondition <em>Inject Widget Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getReturnTypeModifier <em>Return Type Modifier</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDisplayAfterEventDependsOnConditionScript <em>Display After Event Depends On Condition Script</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getInputExpression <em>Input Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getAfterEventExpression <em>After Event Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getTooltip <em>Tooltip</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getHelpMessage <em>Help Message</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getInjectWidgetScript <em>Inject Widget Script</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isDuplicate <em>Duplicate</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isLimitNumberOfDuplication <em>Limit Number Of Duplication</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isLimitMinNumberOfDuplication <em>Limit Min Number Of Duplication</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getMaxNumberOfDuplication <em>Max Number Of Duplication</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getMinNumberOfDuplication <em>Min Number Of Duplication</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDisplayLabelForAdd <em>Display Label For Add</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getTooltipForAdd <em>Tooltip For Add</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getDisplayLabelForRemove <em>Display Label For Remove</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getTooltipForRemove <em>Tooltip For Remove</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getWidgets <em>Widgets</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isShowBorder <em>Show Border</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getLines <em>Lines</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#isUseIterator <em>Use Iterator</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.GroupImpl#getIterator <em>Iterator</em>}</li>
 * </ul>
 *
 * @generated
 */
