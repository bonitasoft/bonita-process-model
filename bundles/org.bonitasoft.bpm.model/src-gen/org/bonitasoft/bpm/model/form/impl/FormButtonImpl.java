...
import org.bonitasoft.bpm.model.form.FormButton;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getTextAnnotationAttachment <em>Text Annotation Attachment</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getHtmlAttributes <em>Html Attributes</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getWidgetLayoutInfo <em>Widget Layout Info</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getShowDisplayLabel <em>Show Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#isAllowHTMLForDisplayLabel <em>Allow HTML For Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getDependOn <em>Depend On</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#isDisplayDependentWidgetOnlyOnEventTriggered <em>Display Dependent Widget Only On Event Triggered</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getParentOf <em>Parent Of</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#isMandatory <em>Mandatory</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getLabelPosition <em>Label Position</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getRealHtmlAttributes <em>Real Html Attributes</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#isInjectWidgetCondition <em>Inject Widget Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getReturnTypeModifier <em>Return Type Modifier</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getDisplayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition <em>Display Dependent Widget Only After First Event Triggered And Condition</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getDisplayAfterEventDependsOnConditionScript <em>Display After Event Depends On Condition Script</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getInputExpression <em>Input Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getAfterEventExpression <em>After Event Expression</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getTooltip <em>Tooltip</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getHelpMessage <em>Help Message</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getInjectWidgetScript <em>Inject Widget Script</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.bonitasoft.bpm.model.form.impl.FormButtonImpl#getLabelBehavior <em>Label Behavior</em>}</li>
 * </ul>
 *
 * @generated
 */
