...
/**
 * A content handler implementation for .conf files.
 */
public class ConfigurationContentHandler extends ContentHandlerImpl {
    ...
    public boolean canHandle(URI uri) {
        return CONF_EXT.equals(uri.fileExtension());
    }
    ...
    public Map<String, Object> contentDescription(URI uri, InputStream inputStream, Map<?, ?> options,
        ...
        res.put(ContentHandler.CONTENT_TYPE_PROPERTY, ConfigurationResourceFactoryImpl.CONTENT_TYPE);
        return res;
    }
}
