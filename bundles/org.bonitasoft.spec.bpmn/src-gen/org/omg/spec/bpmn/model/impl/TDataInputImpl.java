...
public class TDataInputImpl extends TBaseElementImpl implements TDataInput {
    ...
    public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.TDATA_INPUT__DATA_STATE, oldDataState, newDataState);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newDataState != dataState) {
            ...
            if (dataState != null)
                msgs = ((InternalEObject) dataState).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_INPUT__DATA_STATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_INPUT__DATA_STATE, newDataState,
                    newDataState));
    }
    ...
    public void setIsCollection(boolean newIsCollection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_INPUT__IS_COLLECTION,
    ...
    public void unsetIsCollection() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TDATA_INPUT__IS_COLLECTION,
    ...
    public void setItemSubjectRef(QName newItemSubjectRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_INPUT__ITEM_SUBJECT_REF,
