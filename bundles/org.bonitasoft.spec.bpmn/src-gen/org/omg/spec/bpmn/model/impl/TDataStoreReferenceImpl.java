...
public class TDataStoreReferenceImpl extends TFlowElementImpl implements TDataStoreReference {
    ...
    public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.TDATA_STORE_REFERENCE__DATA_STATE, oldDataState, newDataState);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newDataState != dataState) {
            ...
            if (dataState != null)
                msgs = ((InternalEObject) dataState).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_STORE_REFERENCE__DATA_STATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_STORE_REFERENCE__DATA_STATE,
    ...
    public void setDataStoreRef(QName newDataStoreRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_STORE_REFERENCE__DATA_STORE_REF,
    ...
    public void setItemSubjectRef(QName newItemSubjectRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_STORE_REFERENCE__ITEM_SUBJECT_REF,
