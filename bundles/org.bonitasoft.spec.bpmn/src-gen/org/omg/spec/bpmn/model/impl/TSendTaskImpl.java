...
public class TSendTaskImpl extends TTaskImpl implements TSendTask {
    ...
    public void setImplementation(Object newImplementation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSEND_TASK__IMPLEMENTATION,
    ...
    public void unsetImplementation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.TSEND_TASK__IMPLEMENTATION,
    ...
    public void setMessageRef(QName newMessageRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSEND_TASK__MESSAGE_REF, oldMessageRef,
                    messageRef));
    }
    ...
    public void setOperationRef(QName newOperationRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TSEND_TASK__OPERATION_REF,
