...
public class TConversationLinkImpl extends TBaseElementImpl implements TConversationLink {
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONVERSATION_LINK__NAME, oldName,
                    name));
    }
    ...
    public void setSourceRef(QName newSourceRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONVERSATION_LINK__SOURCE_REF,
    ...
    public void setTargetRef(QName newTargetRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TCONVERSATION_LINK__TARGET_REF,
