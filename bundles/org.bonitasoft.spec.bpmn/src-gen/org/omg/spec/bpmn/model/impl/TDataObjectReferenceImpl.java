...
public class TDataObjectReferenceImpl extends TFlowElementImpl implements TDataObjectReference {
    ...
    public NotificationChain basicSetDataState(TDataState newDataState, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.TDATA_OBJECT_REFERENCE__DATA_STATE, oldDataState, newDataState);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newDataState != dataState) {
            ...
            if (dataState != null)
                msgs = ((InternalEObject) dataState).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.TDATA_OBJECT_REFERENCE__DATA_STATE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT_REFERENCE__DATA_STATE,
    ...
    public void setDataObjectRef(String newDataObjectRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT_REFERENCE__DATA_OBJECT_REF,
    ...
    public void setItemSubjectRef(QName newItemSubjectRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TDATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.TDATA_OBJECT_REFERENCE__DATA_OBJECT_REF:
                return DATA_OBJECT_REF_EDEFAULT == null ? dataObjectRef != null
                        : !DATA_OBJECT_REF_EDEFAULT.equals(dataObjectRef);
            case ModelPackage.TDATA_OBJECT_REFERENCE__ITEM_SUBJECT_REF:
    ...
    public String toString() {
        ...
        result.append(" (dataObjectRef: "); //$NON-NLS-1$
