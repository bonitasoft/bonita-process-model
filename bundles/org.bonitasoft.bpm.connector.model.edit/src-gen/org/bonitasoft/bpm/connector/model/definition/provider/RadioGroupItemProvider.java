...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.bpm.connector.model.definition.RadioGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RadioGroupItemProvider extends WidgetItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_RadioGroup_choices_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_RadioGroup_choices_feature", "_UI_RadioGroup_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addOrientationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_RadioGroup_orientation_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_RadioGroup_orientation_feature", "_UI_RadioGroup_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/RadioGroup")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_RadioGroup_type") : //$NON-NLS-1$
            getString("_UI_RadioGroup_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
