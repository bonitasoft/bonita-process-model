...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.bpm.connector.model.definition.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider extends WidgetItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Array_colsCaption_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Array_colsCaption_feature", "_UI_Array_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addColsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Array_cols_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Array_cols_feature", "_UI_Array_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addFixedColsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Array_fixedCols_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Array_fixedCols_feature", "_UI_Array_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addFixedRowsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Array_fixedRows_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Array_fixedRows_feature", "_UI_Array_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addRowsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Array_rows_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_Array_rows_feature", "_UI_Array_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Array")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_Array_type") : //$NON-NLS-1$
            getString("_UI_Array_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
