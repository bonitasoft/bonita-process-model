...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.bpm.connector.model.implementation.JarDependencies} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JarDependenciesItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_JarDependencies_jarDependency_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_JarDependencies_jarDependency_feature", "_UI_JarDependencies_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/JarDependencies")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        return getString("_UI_JarDependencies_type"); //$NON-NLS-1$
    }
