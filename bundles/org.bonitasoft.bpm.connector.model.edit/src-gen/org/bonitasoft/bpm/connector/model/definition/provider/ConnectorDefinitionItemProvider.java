...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.bpm.connector.model.definition.ConnectorDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorDefinitionItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorDefinition_id_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorDefinition_id_feature", "_UI_ConnectorDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorDefinition_version_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorDefinition_version_feature", "_UI_ConnectorDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addIconPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorDefinition_icon_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorDefinition_icon_feature", "_UI_ConnectorDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addJarDependencyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorDefinition_jarDependency_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorDefinition_jarDependency_feature", "_UI_ConnectorDefinition_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectorDefinition")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_ConnectorDefinition_type") : //$NON-NLS-1$
            getString("_UI_ConnectorDefinition_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
