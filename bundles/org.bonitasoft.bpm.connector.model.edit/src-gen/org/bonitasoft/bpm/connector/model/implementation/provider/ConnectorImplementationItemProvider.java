 ...
 */
package org.bonitasoft.bpm.connector.model.implementation.provider;


import java.util.Collection;
import java.util.List;

import org.bonitasoft.bpm.connector.model.definition.provider.ConnectorEditPlugin;
...
/**
 * This is the item provider adapter for a {@link org.bonitasoft.bpm.connector.model.implementation.ConnectorImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorImplementationItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_implementationId_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_implementationId_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addImplementationVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_implementationVersion_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_implementationVersion_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addDefinitionIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_definitionId_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_definitionId_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addDefinitionVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_definitionVersion_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_definitionVersion_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addImplementationClassnamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_implementationClassname_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_implementationClassname_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addHasSourcesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConnectorImplementation_hasSources_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorImplementation_hasSources_feature", "_UI_ConnectorImplementation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectorImplementation")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_ConnectorImplementation_type") : //$NON-NLS-1$
            getString("_UI_ConnectorImplementation_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
