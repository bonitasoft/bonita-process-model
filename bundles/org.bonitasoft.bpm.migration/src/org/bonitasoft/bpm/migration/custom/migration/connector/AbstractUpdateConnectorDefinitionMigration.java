...
public abstract class AbstractUpdateConnectorDefinitionMigration extends CustomMigration
    ...
    public void migrateAfter(final Model model, final Metamodel metamodel) throws MigrationException {
        ...
        for (final Instance connectorConfigInstance : model
            ...
            migrateConnectorConfiguration(model, connectorConfigInstance);
        }
    }

    private void migrateConnectorConfiguration(final Model model, final Instance connectorConfigInstance) {
