...
public class UpdateCMISConnectorVersionCustomMigration extends CustomMigration {
    ...
    private Instance transformVariableExpression(final Model model, final String wsdlPath,
            final Instance urlExpression) {
    ...
    private Instance transformConstantExpression(final Model model, final String wsdlPath,
            final Instance urlExpression) {
        ...
        return StringToExpressionConverter.createExpressionInstance(model, newInputValue, newInputValue,
                String.class.getName(),
    ...
    private void addServiceURL(final Instance connectorConfigInstance, final Model model, final String newInputName,
            final Instance valueExpression) {
