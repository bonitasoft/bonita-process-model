...
public class LegacyTimerExpressionGenerator {
    ...
    public String getTimerExpressionContent(final StartTimerEvent item) {
        switch (item.getScriptType()) {
            ...
            case HOURLY:
                return generateCronExpression(CRON_WILDCARD, CRON_EVERY + item.getHours(), CRON_WILDCARD, CRON_WILDCARD,
                        CRON_NOT_SET);
            case MINUTELY:
                return generateCronExpression(CRON_EVERY + item.getMinutes(), CRON_WILDCARD, CRON_WILDCARD,
    ...
    protected String dailyCron(final StartTimerEvent item) {
        ...
        return generateCronExpression(String.valueOf(calendar.get(Calendar.MINUTE)),
                String.valueOf(calendar.get(Calendar.HOUR_OF_DAY)), CRON_WILDCARD,
                CRON_WILDCARD, CRON_NOT_SET);
    }
    ...
    protected String weeklyCron(final StartTimerEvent item) {
        ...
        calendar.setTime(item.getAt());
        return generateCronExpression(String.valueOf(calendar.get(Calendar.MINUTE)),
                String.valueOf(calendar.get(Calendar.HOUR_OF_DAY)), CRON_NOT_SET,
    ...
    private String generateCronExpression(final String min, final String hour, final String dayOfMonth,
